...
export default function ProjectsList() {
  ...
  return (
    <div ref={projectsContainer} id="projects" className={`projects relative z-0 container h-screen overflow-hidden`}>
      <div className="projects__prev-btn absolute left-1/3 top-2/3 md:top-1/2 md:left-5 md:-translate-y-1/2 xl:left-60 z-10 cursor-pointer">
      ...
      <div className="projects__next-btn absolute right-1/3 top-2/3 md:top-1/2 md:right-5 md:-translate-y-1/2 xl:right-60 z-10 cursor-pointer">
