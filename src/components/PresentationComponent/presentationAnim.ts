...
class PresentationAnimation {
 ...
 #logoContainer: HTMLDivElement | null;
 ...
 init() {
  ...
  this.scroll(this.#logoContainer, this.#splitDescription(this.#description))
 }
 ...
 scroll(
  ...
  description = this.#splitDescription(this.#description)) {
  try {
